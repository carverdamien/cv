...
% \footnotesize{ACDC improves the memory consolidation of the Linux kernel cgroup isolation feature.}\\
% \footnotesize{
% I studied Operating System Level Virtualization as a means of improving resource utilization.
% I have shown that the Linux kernel cannot consolidate the memory of inactive containers without disturbing the services of active containers.
% My kernel patches aim at detecting memory activities to prevent consolidation errors.
% }\\
...
\textsc{Sep 2012} & M.S. in \textsc{Computer Science}, \textsc{Sorbonne University}, Paris\\ % \textsc{University of Pierre and Marie Currie}, Paris\\
...
% Rollerblade, Ice Skating, Running, Skateboard, Video Gaming.
